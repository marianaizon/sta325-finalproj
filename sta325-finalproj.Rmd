...
DAY_OF_WEEK, DEST, CARRIER_DELAY, and LATE_AIRCRAFT_DELAY have very high p-values, so let's try an anova test without including them
...
based on the anova test, the model including these variables is a better fit
...
```{r}
gam_preds <- predict.gam(gam01, newdata = test)
